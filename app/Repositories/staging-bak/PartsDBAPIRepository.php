...
class PartsDBAPIRepository extends BaseRepository
{
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'login in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
        fwrite($fp, "\n");
        // fwrite($fp, 'Filters :' . serialize($filters));
        fwrite($fp, "\n");
        fwrite($fp, '+++++++++++++++++++');
        fwrite($fp, "\n");
        fclose($fp);
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getAllBrands in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getAllCategories in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getAllMakesAndModels in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getAllVehicleByMakesAndModels in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getproductsbyvehicleid($vehicle_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getproductsbyvehicleid in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductCategoriesByBrandIDAndProductNr($brand_id, $product_nr)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductCategoriesByBrandIDAndProductNr in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductCorrespondingPartNmuber($brand_id, $product_nr, $sku)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductCorrespondingPartNmuber in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    {
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductsImages in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductFittingPositions($brand_id, $product_nr, $Stand_desc_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductFittingPositions in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductAttributes($brand_id, $product_nr, $Stand_desc_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductAttributes in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductsSubscribed($brand_id, $PageNum, $PageSize)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductsSubscribed in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getCEDCategoryProducts($category_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getCEDCategoryProducts in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getVehiclesLinkedToProduct($product_nr, $brand_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getVehiclesLinkedToProduct in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function GetEngineCodesByVehicleID($vehicle_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'GetEngineCodesByVehicleID in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getVehiclesByRegoNumber($rego_number, $state, $country_code)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getVehiclesByRegoNumber in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getVehiclesByVIN($vin_number)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getVehiclesByVIN in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getProductCriteria($brand_id, $product_nr, $standD_desc_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getProductCriteria in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getCEDProductCategories($product_nr, $brand_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getCEDProductCategories in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getCEDProductCriteria($brand_id, $product_nr, $company_sku)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getCEDProductCriteria in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
    ...
    public function getCEDProductsSubscribed($brand_id)
    {
        ...
        $fp = fopen('log.txt', 'a+');
        fwrite($fp, 'getCEDProductsSubscribed in PartsDBAPIRepository');
        fwrite($fp, "\n");
        fwrite($fp, 'time:' . date('Y-m-d H:i:s'));
        fwrite($fp, "\n");
        fwrite($fp, 'IP :' . $_SERVER['REMOTE_ADDR']);
