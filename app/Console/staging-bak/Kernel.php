...
class Kernel extends ConsoleKernel
{
    ...
    {
        $schedule->command('sync:partsdb')->dailyAt('11:00')->evenInMaintenanceMode()->withoutOverlapping();
        ...
        $schedule->command('sync:csvproduct:prices')->dailyAt('15:00')->evenInMaintenanceMode()->withoutOverlapping()->runInBackground();
