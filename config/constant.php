...
return [
    ...
    'ADMINISTRATOR_EMAIL_ACT' => env('ADMINISTRATOR_EMAIL_ACT', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_NSW' => env('ADMINISTRATOR_EMAIL_NSW', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_NT' => env('ADMINISTRATOR_EMAIL_NT', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_QLD' => env('ADMINISTRATOR_EMAIL_QLD', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_SA' => env('ADMINISTRATOR_EMAIL_SA', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_TAS' => env('ADMINISTRATOR_EMAIL_TAS', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_VIC' => env('ADMINISTRATOR_EMAIL_VIC', 'arun.ks@experionglobal.com'),
    'ADMINISTRATOR_EMAIL_WA' => env('ADMINISTRATOR_EMAIL_WA', 'arun.ks@experionglobal.com'),

    // 'administrator_email_generic' => env('ADMINISTRATOR_EMAIL_Generic','vicsales@flexibledrive.com.au'),
    'administrator_email_generic' => env('ADMINISTRATOR_EMAIL_Generic','arun.ks@experionglobal.com'),
];
