    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="users-table" class="table table-striped table-bordered table-data" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td_action_{{$user->id}}">
                                        ...
                                        @endphp
                                        <a title="Approve" href="javascript:void(0)" onclick="account_code_alert('Account','Approved', '{{$url_approve}}')" class="badge badge-success color-white" id="sweetalert_demo_9"><i class="zmdi zmdi-check zmdi-hc-fw"></i></a>
                                        <a title="Decline" href="#" onclick="confirmation_alert('Account','Decline','{{$url_decline}}')" class="badge badge-danger color-white"><i class="zmdi zmdi-close zmdi-hc-fw"></i></a>
                                        @endif
										@if($user->admin_approval_status == 2)
											...
											@endphp
											<label class="switch">
												<input {{$checkedStatus}} class="userStatusToggel" type="checkbox" name="is_active" onchange="toggleCheckbox(this,,'{{$url_soft_delete}}','{{$user->id}}')" >
		...
		swal({
			...
			if (result.value) {
				...
				$.ajax({
					type: 'post',
					url: url,
					data : {userId:userId,is_active:isActive},
