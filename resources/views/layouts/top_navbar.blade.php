    ...
    <ul class="navbar-nav nav-right">
        <li class="nav-item dropdown">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <img src="{{(Auth::user()->profile_image) ? Auth::user()->image_url : asset('assets/img/avatars/1.jpg')}}" class="w-35 rounded-circle" alt="Albert Einstein">
            </a>
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                <div class="dropdown-header pb-3">
                    <div class="media d-user">
                        <img class="align-self-center mr-3 w-40 rounded-circle" src="{{(Auth::user()->profile_image) ? Auth::user()->image_url : asset('assets/img/avatars/1.jpg')}}" alt="{{Auth::user()->first_name}} {{Auth::user()->last_name}}">
                ...
                <a class="dropdown-item" href="{{route('my-profile')}}"><i class="icon dripicons-user"></i> Profile</a>
